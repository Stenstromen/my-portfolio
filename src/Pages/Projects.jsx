...
function Projects() {
  return (
    ...
    <div className="bg-opacity-25 container-fluid" style={{backgroundColor:"#fff7f0"}}>
          ...
          >
            <Card style={{ width: "25rem", height: "30rem", border: "none" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Invoice Dashboard for TimeTracking App, school assignement to
                  use Typescript for the first time.
                </Card.Text>
                <Card.Text>
